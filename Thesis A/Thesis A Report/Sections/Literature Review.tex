...
% I need a couple of sentences to link the heat transfer paragraphs to the limitations paragraphs
\noindent \textbf{Link the 'Limitations' section to the 'Heat Transfer' section by explaining how heat transfer is used to improve electrical efficiency to the Shockley-Queisser limit.}\par

\pagebreak
\subsection{Heat Transfer in Photovoltaic Modules}
\noindent Heat transfer is the process by which heat energy moves from one system or body to another as a result of a temperature difference.\par
\noindent Figure \ref{fig:fundamental_concept_of_heat_transfer_diagram} demonstrates this fundamental concept of heat transfer.\par
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.75\linewidth]{Figures/fundamental_concept_of_heat_transfer_diagram.png}
...
\begin{itemize}
    \item Heat transfer can be used to improve the electrical efficiency of photovoltaic modules.
    \item \textbf{What is heat transfer:} Heat transfer is the process by which heat energy moves from one system or body to another as a result of a temperature difference.
    \item \textbf{Types of heat transfer:} The three modes of heat transfer are conduction, radiation and convection.
    \item \textbf{What is the fundamental concept of heat transfer:} I DON'T KNOW YET.
    \item How can heat transfer principles be used to improve the performance of photovoltaic modules?\par

\end{itemize}

\subsubsection{Conduction} % How does conduction transfer heat in pv modules
\begin{itemize}
    \item Conduction is the energy transfer from more energetic particles to less energetic particles of a substance.
\end{itemize}
