...
\noindent - Conduction is the transfer of energy from the more energetic particles of a substance to the adjacent less energetic ones as a result of interactions between the particles.\par
\noindent - The formula used to calculate conductive heat transfer is shown in Equation \ref{eq:rate_of_heat_conduction_function}.\par
