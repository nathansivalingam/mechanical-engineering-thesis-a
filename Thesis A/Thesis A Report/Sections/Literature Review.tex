...
The impact of convective heat transfer on photovoltaic modules is illustrated in Figure 

\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{Figures/convective_heat_transfer_diagram.pdf}
    \caption{Caption}
    \label{fig:enter-label}
\end{figure}

What factors affect convection (equation-related)?\par
What factors affect convection (factors that influence the variables in the equation)?\par
