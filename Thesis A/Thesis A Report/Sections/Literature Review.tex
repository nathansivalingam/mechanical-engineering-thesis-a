...
Schiffman's results, which showcased the effects of vortex generator orientation on photovoltaic module cooling, laid the foundation for further investigations into additional parameters influencing cooling performance. Building on this work, I.R. Chaudhury  specifically examined the impact of vortex generator geometry on photovoltaic module cooling. Chaudhury tested several shapes, including cube, cylindrical, pyramid, inverted pyramid, and winglet configurations. 

\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\linewidth]{Figures/.pdf}
    \caption{Vortex Generator Geometry Configurations. Adapted from \cite{Chaudhury2024TheConvection}}
    \label{fig:thermal_boundary_layer}
\end{figure}

While winglet-shaped vortex generators reduced photovoltaic module temperature by $5^\circ \text{C}$ at $1\,m/s$, their free-convection based design meant that cooling effectiveness diminished at higher wind velocities. In contrast, cylindrical-shaped vortex generators demonstrated the most favourable trend, with greater cooling performance as the velocity increased. Thus, the cylindrical vortex generator was selected for further experimentation, focusing on spacing configurations to promote turbulent flow in the spanwise direction.
