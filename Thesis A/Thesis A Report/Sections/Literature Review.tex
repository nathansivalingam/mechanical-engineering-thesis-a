...
\noindent The inverse linear relationship between temperature and the electrical efficiency of a photovoltaic module is attributed to the band gap reduction, which occurs as the module's temperature increases.\vspace{0.5em}
...
\subsubsection{Electrical Efficiency, $\eta$}\par
...
\subsubsection{Open-circuit voltage, $V_\text{OC}$}\par
...
\noindent Thus, the reduced band gap that results from an increase in the temperature of the photovoltaic module leads to a decrease in the open-circuit voltage.\par\vspace{0.5em}

\pagebreak
% Short circuit current
\subsubsection{Short circuit current, $I_\text{SC}$}\par
...
\begin{figure}[ht]
    ...
    \caption{$J_\text{SC}$ as a function of band gap for a cell with AM 0 and AM 1.5. \cite{HonsbergOpen-CircuitVoltage}}
...
\noindent Therefore, a decreased band gap leads to an increase in the short circuit current.\par

% Fill Factor
\subsubsection{Fill factor, $FF$}\par
\noindent - INSERT EQUATION\par
\noindent - Cite Paper\par
\noindent - Generate graph\par

% Resultant conclusion
\subsubsection{Conclusion}
\noindent - Therefore BLAH BLAH BLAH\par
