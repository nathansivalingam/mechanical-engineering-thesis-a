...
The convective heat transfer coefficient, $h$, is inversely proportional to the thermal boundary layer thickness, $\delta_t$. Therefore, a thinner $\delta_t$ enhances forced convective heat transfer.\vspace{0.5em}
...
- limitations of water -> therefore we choose air
- limitations of fans -> therefore we choose VGs

% RCM: Vortex-generators (leads on to the Vortex generator section of the report)
- An overview of how vortex generators work.\par
- Explain why they can be a very useful tool for forced convective heat transfer.\par
- Example study.\par
- Lead into the next section.\par

% Reiterate why boundary layers are important to convective heat transfer
