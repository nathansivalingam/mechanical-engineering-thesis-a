...
\noindent\textit{Low IQ Explanation}\par
\noindent - As sunlight hits the semiconductor material of the photovoltaic cell, it creates a pair of electron-holes.
\noindent - Electric current is produced when these electron-hole pairs are separated by an electric field.\vspace{0.5em}

\noindent https://www.youtube.com/watch?v=xKxrkht7CpY\vspace{0.5em}

\noindent\textit{High IQ Explanation}\par
\noindent\textcolor{red}{\textbf{Steps:}} \\
\noindent\textcolor{red}{
1. Read through the explanations in the 3 research papers\\
2. Find their references and have a read of those\\
