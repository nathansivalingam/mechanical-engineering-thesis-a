...
A casual inspection of Equation \ref{eq:rayleigh_number_tilted_function} reveals a directly proportional relationship between the tilt angle, $\theta$, and the Rayleigh number for a tilted photovoltaic module, $\text{Ra}_\theta$, in the bounds of $0^\circ$ and $60^\circ$ \cite{Cengel2014NaturalConvection}. Thus, an increase in the tilt angle corresponds to an increase in the Rayleigh number.\vspace{0.5em}

The Nusselt number, $\text{Nu}$, is the ratio of convective to conductive heat transfer. For simple empirical correlations in natural convection, an exponential relationship exists between the average Nusselt number, $\text{Nu}$, and the Rayleigh number, shown in Equation \ref{eq:avg_nusselt_number_natural_convection} \cite{Cengel2014NaturalConvection}.
...
Therefore, the increase in the Rayleigh number leads to an increase in the Nusselt number.\vspace{0.5em}

Moreover, Equation \ref{eq:convective_heat_transfer_coefficient} reveals that an increase in the Nusselt number, $\text{Nu}$, causes an increase in the convective heat transfer coefficient, $h$. \cite{Cengel2014NaturalConvection}.
\begin{equation}
    h = \frac{\text{Nu} \times k}{L_c}
    \label{eq:convective_heat_transfer_coefficient}
\end{equation}

Finally, an inspection of Equation \ref{eq:rate_of_convective_heat_transfer_function} shows that an increase in the convective heat transfer coefficient, $h$, leads to an increase in natural convective heat transfer rate, $\dot{Q}_\text{conv}$.\vspace{0.5em}
