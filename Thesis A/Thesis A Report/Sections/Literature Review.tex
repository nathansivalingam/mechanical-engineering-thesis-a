...
\noindent\underline{Environmental Factors}\par
\noindent - Introduce the concept of environmental factors \par
\begin{itemize}
    \item \textbf{Shading:} A 2013 study led by Alberto Dolara from the Polytechnic University of Milan found that shade significantly effects the performance of photovoltaic modules.
    \item Dolara et al. observed a 31\% drop in the power generated by a single photovoltaic cell when 50\% of the cell was subjected to shade. \cite{Dolara2013ExperimentalModules}
    \item \textbf{Fog:} 
    \item Air Pollution
\end{itemize}
