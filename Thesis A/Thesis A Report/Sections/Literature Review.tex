...
Forced convection refers to a form of heat transfer in which fluid flow over a surface is driven by external mechanisms such as a fan, pump, or wind, rather than by natural buoyancy forces. \cite{Cengel2014IntroductionConcepts}\par
Figure \ref{fig:cooling_of_boiled_egg_forced_convection} demonstrates how forced convective heat transfer can be used to cool a hot egg.\par
